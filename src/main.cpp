...
static const int64_t nTargetTimespan = 60 * 60;  // Tubecoin - every hour
unsigned int nTargetSpacing = 1 * 40; // Tubecoin - 40 seconds
...
unsigned int nStakeMinAge = 24 * 60 * 60; // Tubecoin - 24 hours
unsigned int nStakeMaxAge = 30 * 24 * 60 * 60; // Tubecoin - 30 days
unsigned int nModifierInterval = 10 * 60; // Tubecoin - time to elapse before new modifier is computed
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Tubecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
